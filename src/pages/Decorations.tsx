...
const Decorations = () => {
  ...
  const decorativeProducts = products?.filter(product => 
    product.category.toLowerCase().includes('decoration') || 
        ...
        <div className="container mx-auto px-4 pt-24 flex-grow">
          <div className="text-center max-w-md mx-auto">
            <div className="mb-4">
              ...
              <h2 className="text-xl font-semibold mb-2">Failed to load decorations</h2>
              <p className="text-muted-foreground mb-4">
                We're having trouble loading the decorative products. Please check your connection and try again.
              </p>
            </div>
            <Button 
              onClick={handleRetry} 
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="container mx-auto px-4 pt-24 flex-grow">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-3xl md:text-4xl font-bold animate-fadeIn">Decorations</h1>
          {isRefetching && (
        ...
        {decorativeProducts?.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold mb-2">No decorative products found</h3>
